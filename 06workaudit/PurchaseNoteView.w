...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:256px;left:4px;" onParamsReceive="modelParamsReceive"> 
  ...
  <column name="MATERIELVALUE" type="String" xid="xid5"></column></div></div>  
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" xid="demoPopOver" opacity="0.8" direction="right-top" position="center" style="background-color:black;">
   ...
   <div class="x-popOver-content" xid="div2" style="width:80%;margin-right:10%;margin-left:10%;">
    ...
    <div component="$UI/system/components/justep/row/row" class="x-row" xid="row10" style="background-color:#FFFFFF;height:150px;padding-top:5px;">
  ...
  <div xid="InfoBox" style="width:70%;margin-right:15%;margin-left:15%;height:120px;position:absolute;display:none;z-index:99;top:75px;border-radius:5px;background-color:#ccc;">
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row13" style="height:50px;">
    <div class="x-col" xid="col19" style="text-align:center;color:#000000;font-size:16px;" bind-text='"温馨提醒"'></div></div> 
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row14">
    <div class="x-col" xid="col28" style="text-align:center;">
     <a component="$UI/system/components/justep/button/button" class="btn x-green" label="OK" xid="OkBtn" style="height:30px;text-align:center;line-height:15px;" onClick="OkBtnClick">
      <i xid="i7"></i>
      <span xid="span11">OK</span></a> </div> </div> </div></div> </div><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1" style="background-color:#f0f3f4;">
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="button1" icon="icon-android-close" onClick="button1Click">
   ...
   <div class="x-panel-content" xid="content1">
    <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel2">
     <div class="x-panel-top" xid="top2">
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row8" style="background-color:#3399f3;padding-top:0px;padding-bottom:0px;">
       <div class="x-col" xid="col10" style="text-align:right;padding-right:0px;padding-top:0px;padding-bottom:0px;">
        <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="申请信息" xid="button3" target="navContent1" style="color:#FFFFFF;height:49px;text-align:center;line-height:30px;border-radius:10px  0 0 10px;margin-top:1px;">
         <i xid="i4"></i>
         <span xid="span4">申请信息</span></a> </div> 
       <div class="x-col" xid="col11" style="padding-left:0px;padding-top:0px;padding-bottom:0px;text-align:left;line-height:30px;">
        <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="物料信息" xid="button4" target="navContent2" style="color:#FFFFFF;height:49px;text-align:center;line-height:30px;border-radius:0  10px 10px 0;margin-top:1px;">
         <i xid="i5"></i>
         <span xid="span5">物料信息</span></a> </div> </div> </div> 
     <div class="x-panel-content" xid="content2">
      <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full" active="0" xid="navContents">
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
    <div class="x-col x-col-25" xid="col5" bind-text="'申请日期：'" style="border-color:#e6eaec #e6eaec #e6eaec #e6eaec;border-style:none none inset solid;text-align:center;line-height:35px;border-width:1px 1px 1px 1px;"></div>
    <div class="x-col" xid="col6" style="border-style:none inset inset none;border-width:1px 1px 1px 1px;border-color:#e6eaec #e6eaec #e6eaec #e6eaec;background-color:#FFFFFF;">
     <input component="$UI/system/components/justep/input/input" class="form-control" xid="input2" style="background-color:#FFFFFF;border:0px;height:30px;font-size:16px;" readonly="true" format="yyyy-MM-dd" dataType="String" disabled="true"></input></div> </div> 
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3">
    <div class="x-col x-col-25" xid="col8" bind-text="'采办方式：'" style="border-color:#e6eaec #e6eaec #e6eaec #e6eaec;border-style:none none inset solid;text-align:center;line-height:35px;border-width:1px 1px 1px 1px;"></div>
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
    <div class="x-col x-col-25" xid="col14" bind-text="'要求期限：'" style="border-color:#e6eaec #e6eaec #e6eaec #e6eaec;border-style:none none inset solid;text-align:center;line-height:35px;border-width:1px 1px 1px 1px;"></div>
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5">
    <div class="x-col x-col-25" xid="col20" bind-text="'支付类型：'" style="border-color:#e6eaec #e6eaec #e6eaec #e6eaec;border-style:none none inset solid;text-align:center;line-height:35px;border-width:1px 1px 1px 1px;"></div>
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row6">
    <div class="x-col x-col-25" xid="col17" bind-text="'申请原因：'" style="border-color:#e6eaec #e6eaec #e6eaec #e6eaec;border-style:none none inset solid;text-align:center;line-height:35px;border-width:1px 1px 1px 1px;"></div>
   ...
   <div class="x-col x-col-25" xid="col22" bind-text="'合计金额：'" style="border-color:#e6eaec #e6eaec #e6eaec #e6eaec;border-style:none none inset solid;text-align:center;line-height:35px;border-width:1px 1px 1px 1px;"></div>
   <div class="x-col" xid="col23" style="border-style:none inset inset none;border-width:1px 1px 1px 1px;border-color:#e6eaec #e6eaec #e6eaec #e6eaec;background-color:#FFFFFF;">
    ...
    <div class="x-col" xid="col7" style="text-align:center;border-style:none inset inset none;border-width:1px 1px 1px 1px;border-color:#e6eaec #e6eaec #e6eaec #e6eaec;border-radius:0  0 5px 0;">
     <a component="$UI/system/components/justep/button/button" class="btn x-green" label="通过" xid="passBtn" style="width:115px;" onClick="passBtnClick">
      <i xid="i2"></i>
      <span xid="span2">通过</span></a> </div> </div> 
  </div><div class="x-contents-content  x-scroll-view" xid="navContent2">
   ...
   <div class="x-scroll-content" xid="div26">
    <div component="$UI/system/components/justep/list/list" class="x-list x-cards" xid="list" data="dataWuLiao">
     <ul class="x-list-template x-min-height list-group" xid="listTemplateUl8" componentname="$UI/system/components/justep/list/list#listTemplateUl" id="undefined_listTemplateUl1">
      <li xid="li8" class="x-min-height list-group-item" componentname="li(html)" id="undefined_li2" style="height:auto;background-color:#eee;">
       <div component="$UI/system/components/justep/row/row" class="x-row" xid="row9">
        <div class="x-col x-col-75" xid="col1">
         ...
         <div xid="div24" style="width:100%;float:left;">
          ...
          <span xid="span14">元</span><span xid="span9" style="width:100%;word-wrap:break-word;color:#000000;margin-left:70px;">数量：</span>
          <span xid="span7" bind-text="ref('REQUESTNUM')"></span>
          <span xid="span17" bind-text="ref('BASICUNITNAME')"></span>
  </div> </div> 
        <div class="x-col" xid="col24" style="text-align:center;line-height:60px;">
         
  <div xid="div1" style="width:auto;float:left;text-align:center;line-height:normal;"><span xid="span6" style="width:100%;word-wrap:break-word;color:#FF0000;font-size:large;" bind-text="ref('MATERIELVALUE')"></span><span xid="span12" style="word-wrap:break-word;color:#000000;font-size:16px;">元</span></div></div> </div> </li> </ul> </div> </div> 
   <div class="x-content-center x-pull-up" xid="div27">
    <span class="x-pull-up-label" xid="span44">加载更多...</span></div> </div></div> </div> 
  </div> </div> </div> </div>
  <span component="$UI/system/components/justep/windowReceiver/windowReceiver" xid="windowReceiver1" style="left:15px;top:64px;"></span></div>