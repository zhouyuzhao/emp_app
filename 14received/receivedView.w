...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  ...
  <column label="处理意见:" name="viewcontents" type="String" xid="xid5"></column></div><div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data2" idColumn="ID"><column name="ID" type="String" xid="xid6"></column>
...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top1"><div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="收文接收单">
   <div class="x-titlebar-left" xid="left1"></div>
   <div class="x-titlebar-title" xid="title1">收文接收单</div>
   ...
   <div class="x-panel-top" xid="top2"><div component="$UI/system/components/justep/button/buttonGroup" class="btn-group x-card btn-group x-card btn-group-justified" tabbed="true" xid="buttonGroup1"><a component="$UI/system/components/justep/button/button" class="btn btn-default" label="收文详细" xid="button2" target="content3">
   <i xid="i2"></i>
   <span xid="span2">收文详细</span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="处理记录" xid="button3" target="content4">
   ...
   <div class="x-col x-col-25" xid="col1"><label xid="label2"><![CDATA[处理状态:]]></label>
  </div>
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
   <div class="x-col x-col-25" xid="col5"><label xid="label8"><![CDATA[收文名称:]]></label></div>
   <div class="x-col" xid="col6"><label xid="label9"><![CDATA[]]></label></div>
   </div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3">
   <div class="x-col" xid="col8"><label xid="label10"><![CDATA[收文序号:]]></label></div>
   <div class="x-col" xid="col9"><label xid="label11"><![CDATA[]]></label></div>
   <div class="x-col" xid="col10"><label xid="label12"><![CDATA[原文编号:]]></label></div>
  <div class="x-col" xid="col12"><label xid="label13"><![CDATA[]]></label></div></div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
   <div class="x-col" xid="col13"><label xid="label14"><![CDATA[办文形式:]]></label></div>
   <div class="x-col" xid="col14"><label xid="label15"><![CDATA[]]></label></div>
   <div class="x-col" xid="col15"><label xid="label16"><![CDATA[收文类型:]]></label></div>
  <div class="x-col" xid="col16"><label xid="label17"><![CDATA[]]></label></div></div>
  
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row8">
   <div class="x-col" xid="col7"><label xid="label3"><![CDATA[来文形式:]]></label></div>
   <div class="x-col" xid="col11"><label xid="label1"><![CDATA[]]></label></div>
   <div class="x-col" xid="col20"><label xid="label30"><![CDATA[紧急程度:]]></label></div>
  <div class="x-col" xid="col23"><label xid="label31"><![CDATA[]]></label></div></div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row5">
   <div class="x-col x-col-25" xid="col17"><label xid="label18"><![CDATA[来文单位:]]></label></div>
   ...
   <div class="x-col x-col-25" xid="col26"><label xid="label24"><![CDATA[发文时间:]]></label></div>
  <div class="x-col" xid="col27"><label xid="label25"><![CDATA[]]></label></div></div>
  </div></div>
  <hr xid="hr2" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;"></hr>
  <div xid="div5" class="div5"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list2" data="data2">
  ...
  <hr xid="hr1" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;"></hr></li></ul> </div></div></div></div></div>
   ...
   <div xid="div2">
    <div component="$UI/system/components/justep/row/row" class="x-row" xid="row8">
     <div class="x-col" xid="col7" style="text-align:center;">
      <a component="$UI/system/components/justep/button/button" class="btn x-green" label="流转处理" xid="button4" style="width:70%;" onClick="button4Click">
       <i xid="i4"></i>
       <span xid="span4">流转处理</span></a> </div> 
     <div class="x-col" xid="col11" style="text-align:center;">
      <a component="$UI/system/components/justep/button/button" class="btn x-green" label="办理完成" xid="button5" style="width:70%;" onClick="button5Click">
       <i xid="i5"></i>
       <span xid="span5">办理完成</span></a> </div> </div> </div> </div></div>
   ...
   <div class="panel-heading" xid="heading1">
    <h4 class="panel-title" xid="h41"><![CDATA[审批传阅]]></h4></div> 
   <div class="panel-body" xid="body1">
  
  <div xid="div8"><div component="$UI/system/components/justep/row/row" class="x-row div16" xid="row16" style="display:none;">
   <div class="x-col x-col-80" xid="col35"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit7">
   <label class="x-label" xid="label30"><![CDATA[审批人:]]><font color="red">*</font></label>
   <textarea component="$UI/system/components/justep/textarea/textarea" class="form-control x-edit" xid="textarea3" readonly="true"></textarea></div></div>
   <div class="x-col x-col-center" xid="col36"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="button9" icon="linear linear-book" onClick="button9Click">
   ...
   <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog1" src="$UI/emp_app/15send/personnel.w" onReceive="windowDialog1Receive"></span>
   </div>