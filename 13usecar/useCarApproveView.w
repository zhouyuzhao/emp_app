...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top1"><div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="用车申请单审批">
   <div class="x-titlebar-left" xid="left1"></div>
   <div class="x-titlebar-title" xid="title1">用车申请单审批</div>
   ...
   <div class="x-col" xid="col3"><label xid="label6"><![CDATA[]]></label></div></div>
  </div>
  <div xid="div2"><label xid="label2" style="color:#FF8000;"><![CDATA[申请人出行信息:]]></label><div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
   <div class="x-col" xid="col4"><label xid="label7"><![CDATA[]]></label></div>
   <div class="x-col" xid="col5" style="text-align:center;"><label xid="label8"><![CDATA[→]]></label></div>
   <div class="x-col" xid="col6" style="text-align:center;"><label xid="label9"><![CDATA[]]></label></div></div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
   <div class="x-col x-col-75" xid="col12"><label xid="label10"><![CDATA[事由:]]></label>
  <label xid="label11"><![CDATA[]]></label></div>
   <div class="x-col" xid="col14"><label xid="label12"><![CDATA[随行人数:]]></label>
  <label xid="label13"><![CDATA[]]></label></div>
   </div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row6">
   <div class="x-col" xid="col15"><label xid="label14"><![CDATA[出行时间:]]></label>
  <label xid="label15"><![CDATA[]]></label></div>
   </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row5">
   <div class="x-col" xid="col17"><label xid="label16"><![CDATA[返回时间:]]></label>
  <label xid="label17"><![CDATA[]]></label></div>
   </div>
  </div><div xid="div3"><label xid="label3" style="color:#FF8000;"><![CDATA[申请人司机信息:]]></label><div component="$UI/system/components/justep/row/row" class="x-row" xid="row3">
   <div class="x-col" xid="col7"><label xid="label18"><![CDATA[]]></label></div>
   <div class="x-col" xid="col8"><label xid="label19"><![CDATA[]]></label></div>
   <div class="x-col" xid="col9"><label xid="label20"><![CDATA[]]></label></div></div>
  </div>
  <div xid="div5"><label xid="label21" style="color:#FF8000;"><![CDATA[审批意见:]]></label>
  ...
  <hr xid="hr1" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;"></hr></li></ul> </div></div></div>
